...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('goods', '0002_alter_property_unique_together'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.TextField(blank=True, max_length=100, null=True, unique=True)),
        ...
        migrations.AlterField(
            ...
            name='product_item',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='goods.productsku'),
        ),
    ]
