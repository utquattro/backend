...
class ProductSku(BaseModel):
    """"""
    name = models.TextField(max_length=100, null=True, verbose_name='Название продукта')
    ...
    rate = models.DecimalField(blank=False, default=0, null=False, max_digits=5, decimal_places=1,
